...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("lora_6", "LoraLoaderModelOnly:LoraLoaderModelOnly6:lora_name;LoraLoaderModelOnly:lora_6:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader6:lora_name;WanVideoLoraSelect:WanVideoLoraSelect6:lora;FramePackLoraSelect:FramePackLoraSelect6:lora"),
    ("lora_6_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly6:strength_model;LoraLoaderModelOnly:lora_6:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader6:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect6:strength;FramePackLoraSelect:FramePackLoraSelect6:strength"),
    ("lora_7", "LoraLoaderModelOnly:LoraLoaderModelOnly7:lora_name;LoraLoaderModelOnly:lora_7:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader7:lora_name;WanVideoLoraSelect:WanVideoLoraSelect7:lora;FramePackLoraSelect:FramePackLoraSelect7:lora"),
    ("lora_7_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly7:strength_model;LoraLoaderModelOnly:lora_7:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader7:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect7:strength;FramePackLoraSelect:FramePackLoraSelect7:strength"),
    ("lora_8", "LoraLoaderModelOnly:LoraLoaderModelOnly8:lora_name;LoraLoaderModelOnly:lora_8:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader8:lora_name;WanVideoLoraSelect:WanVideoLoraSelect8:lora;FramePackLoraSelect:FramePackLoraSelect8:lora"),
    ("lora_8_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly8:strength_model;LoraLoaderModelOnly:lora_8:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader8:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect8:strength;FramePackLoraSelect:FramePackLoraSelect8:strength"),
