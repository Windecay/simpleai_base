...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("steps", "KSampler:main_sampler:steps;TiledKSampler:main_sampler:steps;KolorsSampler:main_sampler:steps;BasicScheduler:scheduler_select:steps;Co_Input_Zho:i2i_overall_input:steps;easy int:main_steps:value;GeneralInput:GeneralInput:steps;SceneInput:SceneInput:steps"),
    ("cfg_scale", "KSampler:main_sampler:cfg;TiledKSampler:main_sampler:cfg;KolorsSampler:main_sampler:cfg;CLIPTextEncodeFlux:prompt:guidance;Co_Input_Zho:i2i_overall_input:cfg;GeneralInput:GeneralInput:cfg;SceneInput:SceneInput:cfg"),
    ("sampler", "KSampler:main_sampler:sampler_name;TiledKSampler:main_sampler:sampler_name;KSamplerSelect:sampler_select:sampler_name;KSampler Config (rgthree):i2i_KSampler:sampler_name;GeneralInput:GeneralInput:sampler;SceneInput:SceneInput:sampler"),
    ("scheduler", "KSampler:main_sampler:scheduler;TiledKSampler:main_sampler:scheduler;KolorsSampler:main_sampler:scheduler;BasicScheduler:scheduler_select:scheduler;KSampler Config (rgthree):i2i_KSampler:scheduler;GeneralInput:GeneralInput:scheduler;SceneInput:SceneInput:scheduler"),
    ...
    ("base_model", "CheckpointLoaderSimple:base_model:ckpt_name;UNETLoader:UNETLoader:unet_name;UNETLoader:base_model:unet_name;CheckpointLoaderNF4:base_model:ckpt_name;MZ_KolorsUNETLoaderV2:base_model:unet_name;WanVideoModelLoader:base_model:model;LoadFramePackModel:LoadFramePackModel:model;NunchakuFluxDiTLoader:base_model:model_path;NunchakuQwenImageDiTLoader:base_model:model_name;NunchakuZImageDiTLoader:base_model:model_name;CheckpointLoaderSimple_Any:base_model:ckpt_name;UNETLoader_Any:base_model:unet_name"),
    ("base_model_dtype", "UNETLoader:base_model:weight_dtype"),
    ("base_model_gguf", "UnetLoaderGGUF:base_model_gguf:unet_name;UnetLoaderGGUF_Any:Unet Loader (GGUF) (Any):unet_name;UnetLoaderGGUFAdvanced_Any:Unet Loader (GGUF/Advanced) (Any):unet_name;WanVideoModelLoader:WanVideoModelLoader:model;WanVideoModelLoader:base_model_gguf:model"),
    ("base_model_gguf2", "UnetLoaderGGUF:base_model_gguf2:unet_name;UnetLoaderGGUF_Any:Unet Loader (GGUF) (Any):unet_name;UnetLoaderGGUFAdvanced_Any:Unet Loader (GGUF/Advanced) (Any):unet_name;WanVideoModelLoader:WanVideoModelLoader:model;WanVideoModelLoader:base_model_gguf2:model"),
    ("base_model2", "CheckpointLoaderSimple:base_model2:ckpt_name;UNETLoader:UNETLoader2:unet_name;UNETLoader:base_model2:unet_name;NunchakuQwenImageDiTLoader:base_model2:model_name;NunchakuZImageDiTLoader:base_model2:model_name;CheckpointLoaderSimple_Any:base_model2:ckpt_name;UNETLoader_Any:base_model2:unet_name;WanVideoModelLoader:base_model2:model"),
    ("base_model2_dtype", "UNETLoader:base_model2:weight_dtype"),
    ("inpaint_model", "UnetLoaderGGUF:inpaint_model:unet_name;UnetLoaderGGUF_Any:Unet Loader (GGUF) (Any):unet_name;UnetLoaderGGUFAdvanced_Any:Unet Loader (GGUF/Advanced) (Any):unet_name"),
    ...
    ("lora_speedup2", "LoraLoaderModelOnly:lora_speedup2:lora_name"),
    ("lora_speedup2_strength", "LoraLoaderModelOnly:lora_speedup2:strength_model"),
    ("lora_1", "LoraLoaderModelOnly:LoraLoaderModelOnly1:lora_name;LoraLoaderModelOnly:lora_1:lora_name;LoraLoaderModelOnly:lora_speedup:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader1:lora_name;WanVideoLoraSelect:WanVideoLoraSelect1:lora;FramePackLoraSelect:FramePackLoraSelect1:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_1;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader1:lora_name"),
    ("lora_1_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly1:strength_model;LoraLoaderModelOnly:lora_1:strength_model;LoraLoaderModelOnly:lora_speedup:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader1:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect1:strength;FramePackLoraSelect:FramePackLoraSelect1:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_1;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader1:lora_strength"),
    ("lora_2", "LoraLoaderModelOnly:LoraLoaderModelOnly2:lora_name;LoraLoaderModelOnly:lora_2:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader2:lora_name;WanVideoLoraSelect:WanVideoLoraSelect2:lora;FramePackLoraSelect:FramePackLoraSelect2:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_2;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader2:lora_name"),
    ("lora_2_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly2:strength_model;LoraLoaderModelOnly:lora_2:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader2:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect2:strength;FramePackLoraSelect:FramePackLoraSelect2:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_2;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader2:lora_strength"),
    ("lora_3", "LoraLoaderModelOnly:LoraLoaderModelOnly3:lora_name;LoraLoaderModelOnly:lora_3:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader3:lora_name;WanVideoLoraSelect:WanVideoLoraSelect3:lora;FramePackLoraSelect:FramePackLoraSelect3:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_3;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader3:lora_name"),
    ("lora_3_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly3:strength_model;LoraLoaderModelOnly:lora_3:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader3:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect3:strength;FramePackLoraSelect:FramePackLoraSelect3:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_3;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader3:lora_strength"),
    ("lora_4", "LoraLoaderModelOnly:LoraLoaderModelOnly4:lora_name;LoraLoaderModelOnly:lora_4:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader4:lora_name;WanVideoLoraSelect:WanVideoLoraSelect4:lora;FramePackLoraSelect:FramePackLoraSelect4:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_4;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader4:lora_name"),
    ("lora_4_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly4:strength_model;LoraLoaderModelOnly:lora_4:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader4:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect4:strength;FramePackLoraSelect:FramePackLoraSelect4:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_4;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader4:lora_strength"),
    ("lora_5", "LoraLoaderModelOnly:LoraLoaderModelOnly5:lora_name;LoraLoaderModelOnly:lora_5:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader5:lora_name;WanVideoLoraSelect:WanVideoLoraSelect5:lora;FramePackLoraSelect:FramePackLoraSelect5:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_5;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader5:lora_name"),
    ("lora_5_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly5:strength_model;LoraLoaderModelOnly:lora_5:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader5:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect5:strength;FramePackLoraSelect:FramePackLoraSelect5:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_5;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader5:lora_strength"),
    ("lora_6", "LoraLoaderModelOnly:LoraLoaderModelOnly6:lora_name;LoraLoaderModelOnly:lora_6:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader6:lora_name;WanVideoLoraSelect:WanVideoLoraSelect6:lora;FramePackLoraSelect:FramePackLoraSelect6:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_6;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader6:lora_name"),
    ("lora_6_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly6:strength_model;LoraLoaderModelOnly:lora_6:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader6:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect6:strength;FramePackLoraSelect:FramePackLoraSelect6:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_6;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader6:lora_strength"),
    ("lora_7", "LoraLoaderModelOnly:LoraLoaderModelOnly7:lora_name;LoraLoaderModelOnly:lora_7:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader7:lora_name;WanVideoLoraSelect:WanVideoLoraSelect7:lora;FramePackLoraSelect:FramePackLoraSelect7:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_7;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader7:lora_name"),
    ("lora_7_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly7:strength_model;LoraLoaderModelOnly:lora_7:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader7:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect7:strength;FramePackLoraSelect:FramePackLoraSelect7:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_7;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader7:lora_strength"),
    ("lora_8", "LoraLoaderModelOnly:LoraLoaderModelOnly8:lora_name;LoraLoaderModelOnly:lora_8:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader8:lora_name;WanVideoLoraSelect:WanVideoLoraSelect8:lora;FramePackLoraSelect:FramePackLoraSelect8:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_8;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader8:lora_name"),
    ("lora_8_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly8:strength_model;LoraLoaderModelOnly:lora_8:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader8:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect8:strength;FramePackLoraSelect:FramePackLoraSelect8:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_8;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader8:lora_strength"),
    ("lora_9", "LoraLoaderModelOnly:LoraLoaderModelOnly9:lora_name;LoraLoaderModelOnly:lora_9:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader9:lora_name;WanVideoLoraSelect:WanVideoLoraSelect9:lora;FramePackLoraSelect:FramePackLoraSelect9:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_9;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader9:lora_name"),
    ("lora_9_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly9:strength_model;LoraLoaderModelOnly:lora_9:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader9:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect9:strength;FramePackLoraSelect:FramePackLoraSelect9:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_9;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader9:lora_strength"),
    ("lora_10", "LoraLoaderModelOnly:LoraLoaderModelOnly10:lora_name;LoraLoaderModelOnly:lora_10:lora_name;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader10:lora_name;WanVideoLoraSelect:WanVideoLoraSelect10:lora;FramePackLoraSelect:FramePackLoraSelect10:lora;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_name_10;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader10:lora_name"),
    ("lora_10_strength", "LoraLoaderModelOnly:LoraLoaderModelOnly10:strength_model;LoraLoaderModelOnly:lora_10:strength_model;NunchakuFluxLoraLoader:NunchakuFluxLoraLoader10:lora_strength;WanVideoLoraSelect:WanVideoLoraSelect10:strength;FramePackLoraSelect:FramePackLoraSelect10:strength;NunchakuQwenImageLoraStack:Nunchaku Qwen Image LoRA Stack:lora_strength_10;NunchakuQwenImageLoraLoader:Nunchaku Qwen Image LoRA Loader10:lora_strength"),
    ...
    ("var_number4", "easy float:var_number4:value;SceneInput:SceneInput:var_number4"),
    ("var_number5", "easy float:var_number5:value;SceneInput:SceneInput:var_number5"),
    ("var_number6", "easy float:var_number6:value;SceneInput:SceneInput:var_number6"),
    ("var_number7", "easy int:var_number7:value;SceneInput:SceneInput:var_number7"),
    ("var_number8", "easy int:var_number8:value;SceneInput:SceneInput:var_number8"),
    ("var_number9", "easy int:var_number9:value;SceneInput:SceneInput:var_number9"),
    ("var_number10", "easy int:var_number10:value;SceneInput:SceneInput:var_number10"),
    ("switch_option1", "easy boolean:switch_option1:value;SceneInput:SceneInput:switch_option1"),
    ("switch_option2", "easy boolean:switch_option2:value;SceneInput:SceneInput:switch_option2"),
    ("switch_option3", "easy boolean:switch_option3:value;SceneInput:SceneInput:switch_option3"),
    ("switch_option4", "easy boolean:switch_option4:value;SceneInput:SceneInput:switch_option4"),
    ("i2i_function", "easy int:i2i_function:value"),
    ("i2i_model_type", "easy int:i2i_model_type:value;SceneInput:SceneInput:model_type"),
    ("i2i_model_type2", "easy int:i2i_model_type2:value;SceneInput:SceneInput:model_type2"),
    ("i2i_clip_type", "easy int:i2i_clip_type:value;SceneInput:SceneInput:clip_type"),
    ...
    ("i2i_ip_image3", "LoadImage:i2i_ip_image3:image;SceneInput:SceneInput:ip_image2"),
    ("i2i_ip_image4", "LoadImage:i2i_ip_image4:image;SceneInput:SceneInput:ip_image3"),
    ...
    ("enhance_input_image", "LoadInputImage:enhance_input_image:image_name"),
    ("enhance_uov_method", "EnhanceUovInput:EnhanceUovInput:uov_method"),
    ("enhance_uov_multiple", "EnhanceUovInput:EnhanceUovInput:uov_multiple"),
    ("enhance_uov_tiled_width", "EnhanceUovInput:EnhanceUovInput:uov_tiled_width"),
    ...
    ("enhance_uov_processing_order", "EnhanceUovInput:EnhanceUovInput:uov_processing_order"),
    ...
    ("video", "SimpAIOptionalVideoPath:SimpAIOptionalVideoPath:video;VHS_LoadVideo:Load Video (Upload) 🎥🅥🅗🅢:video;LoadVideo:Load Video:file"),
    ("reference_video", "SimpAIOptionalReferenceVideoPath:SimpAIOptionalReferenceVideoPath:reference_video;VHS_LoadVideo:reference_video:video;LoadVideo:reference_video:file"),
