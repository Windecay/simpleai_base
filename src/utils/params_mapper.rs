...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("clip_model", "DualCLIPLoader:clip_model:clip_name1;DualCLIPLoaderGGUF:DualCLIPLoaderGGUF:clip_name1;DualCLIPLoaderGGUF:clip_model:clip_name1;CLIPLoaderGGUF:CLIPLoaderGGUF:clip_name;CLIPLoaderGGUF:clip_model:clip_name;CLIPLoader:CLIPLoader:clip_name;CLIPLoader:clip_model:clip_name;TripleCLIPLoader:TripleCLIPLoader:clip_name1;TripleCLIPLoader:clip_model:clip_name1;CLIPLoaderGGUF_Any:CLIPLoader (GGUF) (Any):clip_name;DualCLIPLoaderGGUF_Any:DualCLIPLoader (GGUF) (Any):clip_name1;TripleCLIPLoaderGGUF_Any:TripleCLIPLoader (GGUF) (Any):clip_name1"),
    ("clip_model2", "TripleCLIPLoader:clip_model:clip_name2;TripleCLIPLoaderGGUF_Any:TripleCLIPLoader (GGUF) (Any):clip_name2"),
