...
static FOOO2NODE_DATA: &[(&str, &str)] = &[
    ...
    ("base_model", "CheckpointLoaderSimple:base_model:ckpt_name;UNETLoader:UNETLoader:unet_name;UNETLoader:base_model:unet_name;CheckpointLoaderNF4:base_model:ckpt_name;MZ_KolorsUNETLoaderV2:base_model:unet_name;WanVideoModelLoader:WanVideoModelLoader:model;LoadFramePackModel:LoadFramePackModel:model;NunchakuFluxDiTLoader:base_model:model_path;NunchakuQwenImageDiTLoader:base_model:model_name;NunchakuZImageDiTLoader:base_model:model_name;CheckpointLoaderSimple_Any:base_model:ckpt_name;UNETLoader_Any:base_model:unet_name"),
    ("base_model_dtype", "UNETLoader:base_model:weight_dtype"),
    ("base_model_gguf", "UnetLoaderGGUF:base_model_gguf:unet_name;UnetLoaderGGUF_Any:Unet Loader (GGUF) (Any):unet_name;UnetLoaderGGUFAdvanced_Any:Unet Loader (GGUF/Advanced) (Any):unet_name"),
    ("base_model_gguf2", "UnetLoaderGGUF:base_model_gguf2:unet_name;UnetLoaderGGUF_Any:Unet Loader (GGUF) (Any):unet_name;UnetLoaderGGUFAdvanced_Any:Unet Loader (GGUF/Advanced) (Any):unet_name"),
